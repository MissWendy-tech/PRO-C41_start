class Game {
  constructor() {
    ...
    //Para saber cuando el auto este o no en movimiento
  ...
  play() {
    ...
    //Llamamos a la funcion getCarsAtEnd
  ...
  handleResetButton() {
    this.resetButton.mousePressed(() => {
      database.ref("/").set({
        ...
        gameState: 0,
        players: {},
        //Para reestablecer el valor de nuestro campo en la BD
        
      });
      window.location.reload();
    });
  }
//Para mostrar la vida de inicio
  

//Para mostrar una barra de progreso de combustible 
